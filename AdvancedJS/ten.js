// write a JavaScript program that finds and displays the titles of books whose price
// is above the average price.
...
const aboveAverageTitles = books
  .filter(book => book.price > averagePrice)
  .map(book => book.title);

console.log('Average Price:', averagePrice);
console.log('Titles above average price:', aboveAverageTitles);